...
class _$CustomErrorImpl extends _CustomError {
  _$CustomErrorImpl({this.statusCode = -1, required this.message}) : super._();
...
abstract class _CustomError extends CustomError {
  factory _CustomError({final int statusCode, required final String message}) =
      _$CustomErrorImpl;
  _CustomError._() : super._();
